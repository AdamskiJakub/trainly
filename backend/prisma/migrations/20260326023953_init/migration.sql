-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('CLIENT', 'INSTRUCTOR', 'ADMIN');
...
-- AddForeignKey
ALTER TABLE "services" ADD CONSTRAINT "services_instructorId_fkey" FOREIGN KEY ("instructorId") REFERENCES "instructor_profiles"("id") ON DELETE CASCADE ON UPDATE CASCADE;
